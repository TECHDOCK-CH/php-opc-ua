...
/**
 * CreateSubscriptionResponse - result of creating a subscription.
 */
final readonly class CreateSubscriptionResponse implements ServiceResponse
{
    private const int TYPE_ID = 790;
