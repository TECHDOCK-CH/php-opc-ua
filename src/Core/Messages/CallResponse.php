...
/**
 * CallResponse - results of method calls.
 */
final readonly class CallResponse implements ServiceResponse
{
    private const int TYPE_ID = 715;

    /**
     * @param CallMethodResult[] $results
    ...
    public static function decode(BinaryDecoder $decoder): static
    {
        ...
        for ($i = 0; $i < $resultCount; $i++) {
            $results[] = CallMethodResult::decode($decoder);
        }
