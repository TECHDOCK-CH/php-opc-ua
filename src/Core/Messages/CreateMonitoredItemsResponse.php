...
/**
 * CreateMonitoredItemsResponse - result of creating monitored items.
 */
final readonly class CreateMonitoredItemsResponse implements ServiceResponse
{
    private const int TYPE_ID = 754;

    /**
     * @param MonitoredItemCreateResult[] $results
    ...
    public static function decode(BinaryDecoder $decoder): static
    {
        ...
        for ($i = 0; $i < $resultCount; $i++) {
            $results[] = MonitoredItemCreateResult::decode($decoder);
        }
