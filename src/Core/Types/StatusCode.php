    ...
    private const array METADATA = [
        ...
        0x809E0000 => [
            ...
            'description' => 'Expected data is unavailable for the requested time range due to an un-mounted volume, ' .
                'an off-line archive or tape, or similar reason for temporary unavailability.'
        ],
        0x809F0000 => [
            'name' => 'BadEntryExists',
        ...
        0x80E10000 => [
            ...
            'description' => 'The related EngineeringUnit has been changed but this change has not been applied to the device. ' .
        ...
        0x811E0000 => [
            ...
            'description' => 'It is delivered with a dependent Variable value when a dominant or dependent Variable has changed, ' .
                'the value is not legal and the change has not been applied.'
        ],
        0x00A70000 => [
